...
include("../Connection/Connection.php");
	...
	if(isset($_POST["btnSave"]))
	{
		...
		$ins="insert into tbl_complaint(complainttype_id,complaint_date,complaint_details,team_id)values('".$_POST["slctComplainttype"]."',curdate(),'".$_POST["txtComplaintdetails"]."','".$_SESSION["tid"]."')";
  ...
  <table width="200" border="1">
    <tr>
      ...
      <td><label for="slctComplainttype"></label>
        <select name="slctComplainttype" required="required" pattern"[A-Za-z]{3,36}" id="slctComplainttype">
    ...
    <tr>
      ...
      <textarea name="txtComplaintdetails" required="required" pattern"[A-Za-z]{3,36}" id="txtComplaintdetails" cols="45" rows="5" required="required"></textarea></td>
    </tr>
...
<td><a href="Complaint.php?delid=<?php echo $row["complaint_id"];?>">Delete</a>
