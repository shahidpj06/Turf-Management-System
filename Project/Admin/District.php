                                        ...
                                        <div class="white_box mb_30">
                                            ...
                                            <form method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input required="" type="text" class="form-control" id="txt_district" name="txt_district" value="<?php echo $dname;?>">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><a href="District.php?id=<?php echo $data["district_id"];?>" class="status_btn">Delete</a> &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <a href="District.php?eid=<?php echo $data["district_id"];?>&ename=<?php echo $data["district_name"];?>" class="status_btn">Edit</a></td>
                                            </tr>
                                            <?php                    
                                              }
